...
On [RStudio Cloud](https://rstudio.cloud/), there is an extra step to get rtweet up and running (you won't need to do this if your are using RStudio desktop). Follow the instructions to create a Twitter Developer App at <https://web.archive.org/web/20200510175109/https://rtweet.info/articles/auth.html>. Ccopy the name of your App and your key and token into their respective fields below. We will use the `saveRDS()` function to store our app credentials as an R object to reaccess as needed. 
