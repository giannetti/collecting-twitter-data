...
Additionally, Twitter is not as global as is often thought. The top fifteen countries by user count are as follows (as of January 2021). Twitter is blocked in China, although users there may circumvent the block through the use of VPNs. 
...
You could collect data on the intersections of cats and lawyers on the internet (no reason). 
...
pandemic_tweets <- search_tweets2(
  c("\"pandemic university\"", "#covidcampus OR #covidcollege OR #coviduni OR #pandemicU"), 
  n = 500, token = token
)
