...
On RStudio Cloud, there is an extra step to get rtweet up and running (you won't need to do this if your are using RStudio desktop). Go to the file called `twitterapp.rds` in your Files. Follow the instructions to create a Twitter Developer App at <https://web.archive.org/web/20200510175109/https://rtweet.info/articles/auth.html>. Edit the rds file to include the name of your App and your key and token. The Rds file stores a single R object that we will read into our environment with the following line of code. 
